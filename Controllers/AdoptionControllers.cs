...
namespace My_Pet.Controllers
{
    [ApiController]
    [Route("api/adoption")]
    public class AdoptionControllers: ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll(
            ...
            [FromQuery] AdoptionFilter? filters
        )
        {
            try
            {
                ...
                var _pagination = new Pagination<AdoptionDTO, AdoptionFilter>();
        ...
        [HttpPut()]
        public async Task<IActionResult> PutById(AdoptionRequest model)
        {
            try
            {
