...
namespace My_Pet.Controllers
{
    [ApiController]
    [Route("api/sale")]
    public class SaleControllers: ControllerBase
    {
        private readonly DataContext _context;
        private readonly ISale _model;
        private readonly ImageService _imagesService;
        public SaleControllers(DataContext context, ISale model, ImageService imagesService)
        {
             _context = context;
             _model = model;
        ...
        [HttpPost()]
        public async Task<IActionResult> Post(SaleRequest model)
        {
            try
            {
        ...
        [HttpPut()]
        public async Task<IActionResult> PutById(SaleRequest model)
        {
            try
            {
